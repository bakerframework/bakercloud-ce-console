var passwordOptions = function (field,object){
    object.html('');
    ...
    var value = $('#preview_field_'+field).find('.controls').children('input[type="password"]').width();
    $( "#slider_width" ).slider({
        range: "min",
        value: value,
        min: 50,
        ...
        slide: function( event, ui ) {
            ...
            $('#preview_field_'+field).find('.controls').children('input[type="password"]').width(ui.value);
